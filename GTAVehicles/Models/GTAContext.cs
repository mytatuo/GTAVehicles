    ...
    public partial class GTAContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GtaplayerCharacters>(entity =>
            {
                ...
                entity.Property(e => e.CharacterColor).HasMaxLength(255);
                ...
                entity.HasOne(d => d.Player)
                    .WithMany(p => p.GtaplayerCharacters)
                    .HasForeignKey(d => d.PlayerId)
                    .HasConstraintName("FK_GTAPlayerCharacters_GTAPlayers");
            });
            ...
            modelBuilder.Entity<GtaplayerVehicleMods>(entity =>
            {
                ...
                entity.Property(e => e.PlayerVehicleId).HasColumnName("PlayerVehicleID");
                ...
                entity.HasOne(d => d.PlayerVehicle)
                    .WithMany(p => p.GtaplayerVehicleMods)
                    .HasForeignKey(d => d.PlayerVehicleId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
